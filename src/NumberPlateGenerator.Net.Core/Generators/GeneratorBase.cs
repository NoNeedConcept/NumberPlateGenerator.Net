...
namespace NumberPlateGenerator.Net.Core.Generators
{
        ...
        where TSettingsBuilder : SettingsBuilderBase<TSettings>
    {
        ...
        public ILicensePlate Generate<TCustomSettings>(Func<SettingsBuilderBase<TCustomSettings>, TCustomSettings> configure) where TCustomSettings : ISettings => Generate(configure);
    }
}
